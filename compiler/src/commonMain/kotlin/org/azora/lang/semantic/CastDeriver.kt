 ...
 *
 * ```azora
 * impl Cast<Fahrenheit> for Celsius { prop castValue[self: Self&]: Fahrenheit { … } }
 * impl Cast<Kelvin>     for Celsius { prop castValue[self: Self&]: Kelvin     { … } }
 * ```
 *
 ...
 * `castValue` is never callable by that name: a cast is written `value as To`, and
