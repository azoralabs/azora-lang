        ...
        assertEquals("outer completed", run("""
            ...
            func main() {
                for x in 0..<3 {
                    ...
                    std::io::println("outer completed")
                }
            }
        """.trimIndent()))
    }
