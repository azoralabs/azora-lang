...
/**
 * End-to-end tests for the [org.azora.lang.backend.TypeScriptCodegen] backend.
 *
 * Each test compiles a small Azora program to TypeScript, executes it with
 * Node.js, and asserts on the program's standard output — validating that the
 * generated TypeScript is both syntactically valid and semantically matches
 * the interpreter.
 *
 * Tests skip themselves when no suitable `node` is available.
 */
class TypeScriptExecTest {
