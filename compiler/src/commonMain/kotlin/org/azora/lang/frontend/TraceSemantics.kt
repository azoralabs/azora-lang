...
private fun Expr.bindTraceReceiver(receiver: Expr, interpolation: Boolean): Expr = when (this) {
    ...
    is Expr.Seal -> copy(value = value.bindTraceReceiver(receiver, interpolation))
    is Expr.IfExpr -> copy(
    ...
    is Expr.InlineForArgs -> copy(
        iterable = iterable.bindTraceReceiver(receiver, interpolation),
        body = body.bindTraceReceiver(receiver, interpolation),
    )
