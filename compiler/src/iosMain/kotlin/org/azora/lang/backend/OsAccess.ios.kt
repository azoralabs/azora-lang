...
/**
 * iOS has no operating system to ask.
 *
 * The app sandbox exposes no shell, and a process id is of no use inside it. Reads answer "unset" and "." - the same answers a real system gives for
